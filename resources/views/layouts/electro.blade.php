...
<!-- Mirrored from transvelo.github.io/electro-html/{{route('pages.index')}} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jan 2020 06:51:35 GMT -->
...
<head>
        ...
        <title>BeeKeepingGear &#8211; Everything you need for your BeeKeeping</title>

        <link rel="stylesheet" type="text/css" href="/electro/assets/css/bootstrap.min.css" media="all" />
        <link rel="stylesheet" type="text/css" href="/electro/assets/css/font-awesome.min.css" media="all" />
        <link rel="stylesheet" type="text/css" href="/electro/assets/css/animate.min.css" media="all" />
        <link rel="stylesheet" type="text/css" href="/electro/assets/css/font-electro.css" media="all" />
        <link rel="stylesheet" type="text/css" href="/electro/assets/css/owl-carousel.css" media="all" />
        <link rel="stylesheet" type="text/css" href="/electro/assets/css/style.css" media="all" />
        <link rel="stylesheet" type="text/css" href="/electro/assets/css/colors/yellow.css" media="all" />

        <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,700italic,800,800italic,600italic,400italic,300italic' rel='stylesheet' type='text/css'>

        <link rel="shortcut icon" href="/electro/assets/images/fav-icon.png">
    </head>
                ...
                <div class="container">
                    <nav>
                        <ul id="menu-top-bar-left" class="nav nav-inline pull-left animate-dropdown flip">
                            <li class="menu-item animate-dropdown"><a title="Beekeepeinggear.com.au" href="{{route('pages.index')}}"> Welcome to <strong>Beekeepeinggear.com.au </strong></a></li>
                        </ul>
                    </nav>
                    ...
                    <nav>
                        <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                            ...
                            <li class="menu-item animate-dropdown"><a href="{{route('home')}}"> <strong> {{Auth::guard('web')->user()->name}} </strong></a></li> 
                                <li class="menu-item animate-dropdown"><a href= "{{ route('logout') }}" style="color:black"
                            ...
                            @else
                            <li class="menu-item animate-dropdown"><a title="My Account" href="{{route('home')}}"><i class="ec ec-user"></i>My Account</a></li>
                            @endif
                        </ul>
                    </nav>
                </div>
                        ...
                        <ul class="navbar-mini-cart navbar-nav animate-dropdown nav pull-right flip">
                        	<li class="nav-item dropdown">
                        		<a href="cart.html" class="nav-link" data-toggle="dropdown">
                                    <i class="ec ec-shopping-bag"></i> My Cart
                                    @if (Cart::instance('default')->count() > 0)
                        			<span class="cart-items-count count">{{ Cart::instance('default')->count() }}</span>
                                    @endif
                                </a>
                        					...
                        					<ul class="cart_list product_list_widget ">
                        						...
                        						<li class="mini_cart_item">
                        							...
                        							<a href="single-product.html">
                        								<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="{{ productImage($item->model->image) }}" alt="">{{ $item->model->name }}&nbsp;
                        							</a>
                            ...
                            <ul class="product_list_widget">
                                <li>
                                    <a href="single-product.html" title="Tablet Thin EliteBook  Revolve 810 G6">
                                        <img class="wp-post-image" data-echo="assets/images/footer/1.jpg" src="/electro/assets/images/blank.gif" alt="">
                                ...
                                <li>
                                    <a href="single-product.html" title="Smartphone 6S 128GB LTE">
                                        <img class="wp-post-image" data-echo="assets/images/footer/2.jpg" src="/electro/assets/images/blank.gif" alt=""><span class="product-title">Smartphone 6S 128GB LTE</span>
                                    </a>
                                ...
                                <li>
                                    <a href="single-product.html" title="Smartphone 6S 64GB LTE">
                                        <img class="wp-post-image" data-echo="assets/images/footer/3.jpg" src="/electro/assets/images/blank.gif" alt="">
                            ...
                            <ul class="product_list_widget">
                                ...
                                <li>
                                    <a href="single-product.html" title="Tablet Red EliteBook  Revolve 810 G2">
                                        <img class="wp-post-image" data-echo="assets/images/footer/4.jpg" src="/electro/assets/images/blank.gif" alt="">
                                ...
                                <li>
                                    <a href="single-product.html" title="Widescreen 4K SUHD TV">
                                        <img class="wp-post-image" data-echo="assets/images/footer/5.jpg" src="/electro/assets/images/blank.gif" alt="">
                    ...
                    <aside class="widget clearfix">
                        <div class="body">
                            ...
                            <ul class="product_list_widget">
                                <li>
                                    <a href="single-product.html" title="Notebook Black Spire V Nitro  VN7-591G">
                                        <img class="wp-post-image" data-echo="assets/images/footer/6.jpg" src="/electro/assets/images/blank.gif" alt="">
                                        <span class="product-title">Notebook Black Spire V Nitro  VN7-591G</span>
                                    </a>
                                ...
                                <li>
                                    <a href="single-product.html" title="Apple MacBook Pro MF841HN/A 13-inch Laptop">
                                        <img class="wp-post-image" data-echo="assets/images/footer/7.jpg" src="/electro/assets/images/blank.gif" alt="">
                                ...
                                <li>
                                    <a href="single-product.html" title="Tablet White EliteBook Revolve  810 G2">
                                        <img class="wp-post-image" data-echo="assets/images/footer/2.jpg" src="/electro/assets/images/blank.gif" alt="">
            ...
            <div class="pull-right flip payment">
                <div class="footer-payment-logo">
                    <ul class="cash-card card-inline">
                        <li class="card-item"><img src="/electro/assets/images/footer/payment-icon/1.png" alt="" width="52"></li>
                        <li class="card-item"><img src="/electro/assets/images/footer/payment-icon/2.png" alt="" width="52"></li>
                        <li class="card-item"><img src="/electro/assets/images/footer/payment-icon/3.png" alt="" width="52"></li>
                        <li class="card-item"><img src="/electro/assets/images/footer/payment-icon/4.png" alt="" width="52"></li>
                        <li class="card-item"><img src="/electro/assets/images/footer/payment-icon/5.png" alt="" width="52"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<!-- Mirrored from transvelo.github.io/electro-html/{{route('pages.index')}} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jan 2020 06:52:39 GMT -->
</html>
