                            ...
                            <tbody>
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="{{ route('shop.show_2', $item->model->slug) }}"><img width="180" height="180" src="{{ productImage($item->model->image) }}" alt=""></a>
                                    </td>

                                    <td data-title="Product" class="product-name">
                                        <a href="{{ route('shop.show_2', $item->model->slug) }}">{{ $item->model->name }}</a>
                                    </td>
                                ...
                                <tr>
                                    <td class="actions" colspan="6">
                                        ...
                                        <div class="coupon">
                                            ...
                                            <label for="coupon_code">Coupon:</label>                                        <input type="text" name="coupon_code" id="coupon_code" placeholder="Coupon Code">
                                ...
                                <tbody>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td data-title="Subtotal">
                                            <span class="amount">{{ presentPrice(Cart::subtotal()) }}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="shipping">
                                        ...
                                        <td data-title="Shipping">Flat Rate: <span class="amount">$300.00</span> <input type="hidden" class="shipping_method" value="international_delivery" id="shipping_method_0" data-index="0" name="shipping_method[0]">
                                            ...
                                            <form method="post" action="https://transvelo.github.io/electro-html/cart.html" class="woocommerce-shipping-calculator">
                                    ...
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td data-title="Total"><strong><span class="amount">{{ presentPrice($newTotal) }}</span></strong> </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            Array.from(classname).forEach(function(element) {
                element.addEventListener('change', function() {
                    ...
                    .then(function (response) {
                        ...
                        window.location.href = '{{ route('cart.index_2') }}'
                    })
