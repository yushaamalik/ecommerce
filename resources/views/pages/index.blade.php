    ...
    <div class="handheld-navigation-wrapper">   
        ...
        <div class="handheld-navigation hidden-lg-up" id="default-hh-header"> 
            ...
            <ul id="menu-all-departments-menu-1" class="nav nav-inline yamm">
                <li class="list-group-item"><span><i class="fa fa-list-ul"></i><a href="{{route('pages.index')}}">Home </a></span></li>
                <li class="list-group-item"><span><i class="fa fa-list-ul"></i> Categories</span></li>
                            ...
                            <div class="col-md-offset-3 col-md-5">
                                <div class="caption vertical-center text-left">
                                    ...
                                    <div class="hero-action-btn fadeInDown-4">
                                        <a href="{{route('shop.index_2')}}" class="big le-button ">Start Buying</a>
                                    </div>
                                </div><!-- /.caption -->
                            </div>
                        </div>
            ...
            <div class="ads-block row">
                <div class="ad col-xs-12 col-sm-4">
                    <div class="media">
                        <div class="media-left media-middle">
                            <img data-echo="/electro/assets/images/deals/1.jpg" src="/electro/assets/images/blank.gif" alt="">
                        </div>
                        <div class="media-body media-middle">
                            <div class="ad-text">
                                Catch Big <br><strong>Deals</strong> on the <br>Beekeeping Suits
                            </div>
                            <div class="ad-action">
                                <a href="{{route('shop.index_2')}}" target="_blank">Shop now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ad col-xs-12 col-sm-4">
                    <div class="media">
                        ...
                        <div class="media-body media-middle">
                            <div class="ad-text">
                                Extractors<br> Beetle Traps<br> <strong>and more</strong>
                            </div>
                            <div class="ad-action">
                                <a href="{{route('shop.index_2')}}" target="_blank"><span class="upto"><span class="prefix">Upto</span><span class="value">70</span><span class="suffix"></span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ad col-xs-12 col-sm-4">
                    <div class="media">
                        ...
                        <div class="media-body media-middle">
                            <div class="ad-text">
                                Shop the <br><strong>Beekeeping</strong><br> Products
                            </div>
                            <div class="ad-action">
                                <a href="{{route('shop.index_2')}}" target="_blank">Shop now</a>
                            </div>
                        ...
                        <div class="onsale-product">
                            <a href="shop.html">
                                <div class="product-thumbnail">
                                    <img class="wp-post-image" data-echo="/electro/assets/images/deals/1.jpg" src="/electro/assets/images/deals/1.jpg" alt=""></div>
                                    ...
                                    <li class="product">
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3><a href="{{ route('shop.show_2', $sale->product['slug']) }}"><div class="product-name">{{ $sale->product['name'] }}</div></a>
                                                    </h3>
                                                    <div class="product-thumbnail">
                                                        <a href="{{ route('shop.show_2', $sale->product['slug']) }}"><img src="{{ productImage($sale->product['image']) }}" alt="product"></a>
                                                ...
                                                <div class="price-add-to-cart">
                                                    <span class="price">
                                                        <span class="electro-price">
                                                        <ins><span class="amount"> $    {{presentPrice($sale->product['price'])}}/-</span></ins>
                                                            <span class="amount"> </span>
                                                        </span>
                                                    </span>
                                                    <a rel="nofollow" href="single-product.html" class="button add_to_cart_button">Add to cart</a>
        ...
        <section class="products-2-1-2 animate-in-view fadeIn animated" data-animation="fadeIn">
            ...
            <div class="container">
                ...
                <ul class="nav nav-inline nav-justified">
                    ...
                    <li class="nav-item"><a href="{{route('shop.index_2')}}" target="_blank"  class="active nav-link">{{$category->name}}</a></li>
                    @endforeach
                </ul>
